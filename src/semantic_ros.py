...
pub_1 = rospy.Publisher("robot_1_semantic", Image, queue_size=10)
...
def callback_1(data):
    ...
    # img = (np.reshape(img_raveled, (img_size[0], img_size[1]))).astype(np.uint8)
...
def listener():
    ...
    rospy.Subscriber("semantic_1", numpy_msg(Floats), callback_1)
    rospy.spin()
